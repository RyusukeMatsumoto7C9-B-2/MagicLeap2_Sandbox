...
namespace MagicLeap.MRTK.SpatialAwareness
{
        ...
        BaseSpatialMeshObserver
    {
        ...
        private MagicLeapSpatialMeshObserverProfile profile;
        ...
        public override void Enable()
        {
            ...
            subsystemComponent = meshParent.gameObject.AddComponent<MeshingSubsystemComponent>();
            ...
            meshParent.transform.position = mainCamera.transform.position;
        ...
        public void ForiceUpdateMeshData()
        {
#if UNITY_MAGICLEAP || UNITY_ANDROID
        ...
        private void GeneralRendering(MeshRenderer meshRenderer)
        {
            ...
            if (profile.RenderMode == GeneralMeshRenderMode.None)
            {
                meshRenderer.enabled = false;
            }
            else if (profile.RenderMode == GeneralMeshRenderMode.PointCloud)
            {
                meshRenderer.enabled = true;
                meshRenderer.material = profile.PointCloudMaterial;
            }
            else if (profile.RenderMode == GeneralMeshRenderMode.Colored)
            {
                meshRenderer.enabled = true;
                meshRenderer.material = profile.ColoredMaterial;
            }
            else if (profile.RenderMode == GeneralMeshRenderMode.Occlusion)
            {
                meshRenderer.enabled = true;
        ...
        private void UpdateBounds()
        {
            ...
            {
                wireframeCube = GameObject.Instantiate(profile.VisualBounds, meshParent.transform);
                wireframeCube.name = "WireframeCube";
            }

            wireframeCube.SetActive(profile.IsBounded);
            subsystemComponent.gameObject.transform.localScale = profile.IsBounded ? profile.BoundedExtentsSize : profile.BoundlessExtentsSize;
        }
