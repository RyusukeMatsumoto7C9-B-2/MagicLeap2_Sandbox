...
namespace MagicLeap.MRTK.SpatialAwareness
{
    ...
    {
        [Header("Magic Leap Settings Used")]
        ...
        [Tooltip("A visual representation of the meshing bounds. Will only display if isBounded is true.")]
        public GameObject VisualBounds = null;
        ...
        public GeneralMeshRenderMode RenderMode = GeneralMeshRenderMode.Colored;

        [Tooltip("The material to apply for occlusion.")]
        public new Material OcclusionMaterial = null;
